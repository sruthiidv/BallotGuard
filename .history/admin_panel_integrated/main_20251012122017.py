...
LEADING CANDIDATE
================
{leading_candidate['name'] if leading_candidate else 'None'}
Votes: {leading_candidate['votes'] if leading_candidate else 0}
Percentage: {leading_candidate['percentage']:.1f}% if leading_candidate else 0
...
"""
    ...
    def view_selected_election_results(self):
        ...
        if success:
            ...
            self.notebook.select(0)  # Select first tab (Dashboard)
            self.refresh_dashboard()
        else:
