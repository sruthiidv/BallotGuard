...
# Add server_backend to path
server_backend_path = os.path.join(os.path.dirname(__file__), '..', 'server_backend')
sys.path.append(server_backend_path)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                stats = {
                    ...
                    'active_elections': data.get('elections', 0),  # Simplified
...
def test_database_connection():
    ...
    if db_connector.db_available:
        ...
        success, message, stats = db_connector.get_database_stats()
        if success:
